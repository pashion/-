...
<div class="user_style  clearfix">
 <div class="margin_sx">
  ...
  <div id="menu">
   ...
   <dl>
    <dt>我的邀请</dt>
    <dd><a href="#" class="hover">已邀请用户</a></dd>
   </dl>
   <dl>
    <dt>设置</dt>
    <dd><a href="#" >个人资料</a></dd>
 ...
 <!--邀请用户列表-->
    <div class="right_content clearfix">
     <div class="common_Management Invite_users">
     <div class="title_name">已邀请的用户</div>
     <div class="Invite_user_list backgroundcolor padding">
      <table class="table">
       <tbody>
        <tr>
         <td class="Avatar"><span class="Avatar_bg"></span><img src="images/touxiang.jpg"  width="50" height="50"/></td>
         <td width="190">14565654567</td>
         <td width="200">张天师</td>
         <td width="250">2016-10-12 12:21:23</td>
         <td width="150"><a href="#" class="Bonus_points_btn">赠送积分</a></td>
        </tr>
        <tr>
         <td class="Avatar"><span class="Avatar_bg"></span><img src="images/touxiang.jpg"  width="50" height="50"/></td>
         <td width="190">14565654567</td>
...
<script>
 $('.pagination').css({
   "margin-left":($(".Invite_user_list").width() - $('.pagination').outerWidth())/2, 
   });
