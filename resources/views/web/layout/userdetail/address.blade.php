...
<head>
    ...
    <link href="{{url('web')}}/css/address.css" type="text/css" rel="stylesheet" />
</head>
<body>
<hr>
            ...
            <form >
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" name="get_name" class="form-control" id="get_name" >
                    </div>
                            ...
                            <form action="{{url('user/detail/updateaddress')}}" method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group text-left ">
                                        <label for="exampleInputName2"><span style="color: red">*</span>收货人：</label>
                                        <input type="text" name="get_name" class="form-control" value="{{$user->get_name}}" >
                                    </div>
                                    ...
                                    <div class="form-group text-left ">
                                        <label for="exampleInputName2" ><span style="color: red">*</span>详细地址：</label>
                                        <input type="text" class="form-control" name="detaile_address" value="{{$user->detaile_address}}">
                                    </div>
