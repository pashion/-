	...
	<div class="header">
		<div class="header_top">
			<div class="top_info clearfix">
				<div class="logo_style l_f"><a href="{{url('/')}}"><img src="{{url('zhuazi')}}/images/logo.jpg" /></a></div>
	...
	<div class="ms-side" style="margin-top: 20px;" >
		<article class="side-menu side-menu-off">
			<dl class="side-menu-tree" style="padding-left: 30px;">
				...
				<dd>
					<a href="{{url('user/detail/mytalk')}}">我的评价</a>

				</dd>
				<dd>
					<a href="{{url('user/detail/myfoot')}}">我的足迹</a>

				</dd>
				<dd>
					<a href="{{url('user/detail/mysail')}}">优惠券</a>
				</dd>
				...
				<dd>
					<a href="{{url('user/detail/abord')}}">退换货</a>
