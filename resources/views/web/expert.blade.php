...
.divfile{ width:69px; height:35px;margin-left:79px; overflow:hidden;}
.divbox3{ width:100%; height:73px;}
.divbox3 ul{ margin-left:69px;}
.divbox3 ul li{ width:60px; overflow:hidden; background:#f9f9f9; height:60px; position:relative; margin-left:12px; float:left; cursor:pointer;margin-bottom:15px;}
.divbox3 ul li img{ width:100%; position:absolute; margin:auto; overflow:auto; left:0;right:0; top:0; bottom:0;}
.divbox3 ul li span{ width:60px; height:60px; line-height:60px; color:#fff; text-align:center; display:none; position: absolute;left:0; top:0; -khtml-opacity:0.5;-moz-opacity:0.5;filter:alpha(opacity=50);filter:"alpha(opacity=50)";opacity:0.5; filter:progid:DXImageTransform.Microsoft.Alpha(opacity=50); background:#000;}
...
<div class="item">
	<div class="item_list">
    	找找感觉<em class="m_jt"><img src="images/m_jt.jpg" /></em><a href="#" class="item_list_a">色彩潮流</a><a href="#" class="item_list_a">美居秀秀</a><a href="#" style="color:#88c522;" class="item_list_a">有请专家</a>
    </div>
    <div class="item_tztip">
    	<a href="#" class="z_share"><em><img src="images/icon_share.jpg" /></em>分享</a><span onclick="ShowDiv('MyDiv','fade')" class="wyft_btn">我要提问</span>
    </div>
</div>
...
<div class="z_main">
	<div class="z_mainbox3">
    	<div class="z_box3tw"><span class="color_green">[提问]</span><a href="#">窗帘配色，该以怎样的色彩才能媒俘获芳心？</a></div>
        <div class="z_boox3pic">
        	<ul>
            	<li><img src="images/zj_img01.jpg" /></li>
                <li><img src="images/zj_img01.jpg" /></li>
                <li><img src="images/zj_img01.jpg" /></li>
                <li><img src="images/zj_img01.jpg" /></li>
            </ul>
        </div>
        <div class="z_box3hf"><span class="color_green">[专家回复]</span>你有自负的天性，但你爱上了低调。你出色，但你又远离江湖。黑白灰的水墨世界，是一幅诗意的山水，一抹华丽的色彩在画面中绽放，这是你无法掩盖的光芒。黑白灰的家居搭配一个华丽的色调，演绎一个个不同寻常的人生。卓尔不群的人卓尔不群的人
        </div>
        <div class="z_box3sc">
        	<a href="#"><em><img src="images/icon_sc.png" /></em>收藏</a>
        </div>
    </div>
    <div class="z_mainbox3">
    	<div class="z_box3tw"><span class="color_green">[提问]</span><a href="#">窗帘配色，该以怎样的色彩才能媒俘获芳心？</a></div>
...
<div id="MyDiv" class="white_content">
    ...
    <div class="divbox1">
    	<span class="divboxtip">问题:</span><input type="text" class="divinput" />
    </div>
    <div class="divbox2">
    	<input type="file" class="divfile fl" /><span style="color:#999; padding-left:10px;">仅支持JPG,PNG GIF,JPEG,BMP格式，文件小于4M</span>
    </div>
    <div class="divbox3">
    	<ul>
