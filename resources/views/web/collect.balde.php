...
<div class="user_style  clearfix">
 <div class="margin_sx">
  ...
  <dl>
   ...
   <dl>
    <dt>我的收藏</dt>
    <dd><a href="用户中心-收藏.html" class="hover">设计师案例</a></dd>
    <dd><a href="#">场景方案</a></dd>
    <dd><a href="#">单品</a></dd>
    <dd><a href="#">话题</a></dd>
   </dl>
      ...
      <table class="table">
       <tbody>
        <tr>
         <td>
          <a href="#" class="name">
          <img src="images/product/02_small.jpg"  width="140px" height="140px;"/>
          <h4>优丽美家 台灯遥控卧室床头水晶客厅床头灯护眼温馨创意 金色 </h4>
          </a>
          <h3 class="price">￥45.3</h3>
         </td>
         <td>
          <a href="#" class="name">
          <img src="images/product/02_small.jpg"  width="140px" height="140px;"/>
...
<script>
 $('.pagination').css({
   "margin-left":($(".Collection_list").width() - $('.pagination').outerWidth())/2, 
   });
