 ...
 <div class="Scenario_Type">
   <div class="Typename">
    ...
    <a href="javascript:ovid()" class="next"><i class="icon iocn_next"></i></a>
      <div class="bd">
       <ul>
        <li><a href="#"><img src="images/product/p-3.jpg"  height="400" width="280px"/></a></li>
